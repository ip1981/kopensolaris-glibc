...
enum
{
  PTHREAD_MUTEX_TIMED_NP = 0x00,
  PTHREAD_MUTEX_RECURSIVE_NP = 0x06,	/* LOCK_RECURSIVE | LOCK_ERRORCHECK */
  PTHREAD_MUTEX_ERRORCHECK_NP = 0x02,	/* LOCK_ERRORCHECK */
  PTHREAD_MUTEX_ADAPTIVE_NP = 0x00 // TODO
#ifdef __USE_UNIX98
  ,
...
enum
{
  PTHREAD_MUTEX_STALLED_NP = 0x00,
  PTHREAD_MUTEX_ROBUST_NP = 0x40	/* LOCK_ROBUST */
};
#endif
...
enum
{
  ...
  PTHREAD_PRIO_INHERIT = 0x10,	/* LOCK_PRIO_INHERIT */
  PTHREAD_PRIO_PROTECT = 0x20	/* LOCK_PRIO_PROTECT */
};
#endif
...
#define PTHREAD_RWLOCK_INITIALIZER      \
    {0, PTHREAD_PROCESS_PRIVATE, 0x5257 /* RWL_MAGIC */,    \
...
# define PTHREAD_RWLOCK_WRITER_NONRECURSIVE_INITIALIZER_NP  \
    ...
    0x5257 /* RWL_MAGIC */,  PTHREAD_MUTEX_INITIALIZER,     \
...
enum
{
  PTHREAD_SCOPE_SYSTEM = 0x01,	/* THR_BOUND */
...
enum
{
  PTHREAD_PROCESS_PRIVATE = 0x00,
#define PTHREAD_PROCESS_PRIVATE PTHREAD_PROCESS_PRIVATE
  PTHREAD_PROCESS_SHARED = 0x01		/* LOCK_SHARED */
...
#define PTHREAD_COND_INITIALIZER    \
    {{{0, 0, 0, 0}, PTHREAD_PROCESS_PRIVATE, 0x4356 /* COND_MAGIC */}, 0}
...
#endif
extern int pthread_mutex_reltimedlock_np (pthread_mutex_t *__restrict __mutex,
                                    __const struct timespec *__restrict
